                    ...
                    <tbody>
                        {bhagwadGeeta.map(geeta => (
                            <tr key={geeta.id} className="border-b border-gray-200 hover:bg-gray-100 transition">
                                ...
                                <td className="p-4">
                                    <img src={`https://rrr.jatssdev.com/geeta/${geeta.icon}`} alt="Icon" className="w-10 h-10 rounded-full" />
                                </td>
                                <td className="p-4">
                                    <a href={`https://rrr.jatssdev.com/geeta/${geeta.pdf_url}`} target="_blank" rel="noopener noreferrer"
